...
export default function HomePage() {
  ...
  useEffect(() => {
    const autoLocale = localeOptions.find((option) => navigator.language.toLowerCase().startsWith(option.code))
    if (autoLocale) {
  ...
  return (
    <div className="relative flex min-h-screen w-full items-start justify-center overflow-hidden px-4 py-8 md:py-12">
      ...
      <div className="relative flex w-full max-w-7xl flex-col gap-6 rounded-[2rem] border border-white/60 bg-white/40 p-6 shadow-[0_8px_32px_0_rgba(31,38,135,0.15)] backdrop-blur-2xl backdrop-saturate-150 md:gap-8 md:p-10">
        ...
        <header className="relative flex flex-col items-center gap-4 text-center md:gap-6">
          <h1 className="bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-3xl font-bold tracking-tight text-transparent md:text-5xl">
            {t.title}
          </h1>
